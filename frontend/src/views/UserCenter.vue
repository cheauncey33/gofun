<template>
  <div class="narrow-page">
    <div class="page-header">
      <div>
        <h3>个人中心</h3>
        <p class="page-subtitle">查看账户信息、维护手机号和密码</p>
      </div>
    </div>
    ...
    <el-card shadow="never" class="section-card">
      ...
      <el-descriptions :column="1">
        ...
        <el-descriptions-item label="注册时间">{{ shortDateTime(user.CreateTime).slice(0, 10) }}</el-descriptions-item>
      </el-descriptions>
    </el-card>

    <el-card shadow="never" class="section-card">
      <template #header><span class="section-title">修改信息</span></template>
      <el-form :model="infoForm" label-width="90px">
        <el-form-item label="手机号"><el-input v-model="infoForm.phone" placeholder="11 位手机号" /></el-form-item>
        <el-form-item label="头像 URL"><el-input v-model="infoForm.avatar_url" placeholder="头像图片链接" /></el-form-item>
