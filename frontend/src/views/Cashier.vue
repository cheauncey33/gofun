...
.payment-panel { padding: 32px; border: 1px solid var(--line-strong); background: rgba(255,255,255,.2); }
...
.order-strip { min-height: 190px; padding: 28px 35px; border: 1px solid var(--line-strong); display: grid; grid-template-columns: 1fr 230px; position: relative; }
...
.payment-method { min-height: 92px; margin-top: 14px; padding: 18px; border: 1px solid var(--line-strong); display: grid; grid-template-columns: 22px 46px 1fr auto; gap: 14px; align-items: center; }.payment-method.selected { border-color: var(--red); }.payment-method.disabled { opacity: .52; }.payment-method input { accent-color: var(--red); }.payment-method > i { width: 38px; height: 38px; background: var(--red); color: white; display: grid; place-content: center; font: normal 24px var(--font-display); }.payment-method span { display: grid; gap: 6px; }.payment-method small { color: var(--muted); font-size: 11px; }.payment-method em { color: var(--muted); font-size: 11px; font-style: normal; text-align: right; }.payment-method em b { color: var(--ink); }.future-icons { display: block !important; color: var(--muted); font: 14px var(--font-display); }
...
.primary-button, .outline-button { min-width: 150px; height: 48px; padding: 0 22px; border: 1px solid var(--red); background: var(--red); color: white; font-weight: 700; cursor: pointer; }.primary-button:disabled { opacity: .48; cursor: not-allowed; }.outline-button { border-color: var(--line-strong); background: transparent; color: var(--ink); }.payment-actions .primary-button { min-width: 270px; }.text-button { margin-top: 18px; border: 0; border-bottom: 1px solid var(--ink); background: transparent; cursor: pointer; }
.safety-note { padding: 20px; border-top: 3px solid var(--red); background: var(--paper-deep); }.safety-note p { color: var(--muted); font-size: 12px; line-height: 1.75; }
.result-state { min-height: 520px; border: 1px solid var(--line-strong); display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center; }.result-state small { color: var(--red); letter-spacing: .18em; }.result-state h1 { margin: 16px 0 7px; font: 750 34px var(--font-display); }.result-state p { max-width: 520px; margin: 0 0 28px; color: var(--muted); line-height: 1.7; }.result-state > strong { margin: -10px 0 24px; color: var(--red); font: 750 30px var(--font-display); }.result-state .outline-button { margin-top: 12px; }
