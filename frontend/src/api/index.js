...
export default {
  ...
  organizerGetOverview: (organizerId, params) => get(`/organizers/${organizerId}/overview`, params),
  ...
  organizerGetHalls: (organizerId, venueId) => get(`/organizers/${organizerId}/venues/${venueId}/halls`),
  organizerCreateHall: (organizerId, venueId, data) => post(`/organizers/${organizerId}/venues/${venueId}/halls`, data),
  organizerGetHallLayouts: (organizerId, hallId) => get(`/organizers/${organizerId}/halls/${hallId}/layouts`),
  organizerCreateHallLayout: (organizerId, hallId, data) => post(`/organizers/${organizerId}/halls/${hallId}/layouts`, data),
  organizerUpdateHallLayout: (organizerId, layoutId, data) => put(`/organizers/${organizerId}/layouts/${layoutId}`, data),
  organizerPublishHallLayout: (organizerId, layoutId) => post(`/organizers/${organizerId}/layouts/${layoutId}/publish`),
  organizerConfigureSessionSeatMap: (organizerId, sessionId, data) => put(`/organizers/${organizerId}/sessions/${sessionId}/seat-map`, data),
